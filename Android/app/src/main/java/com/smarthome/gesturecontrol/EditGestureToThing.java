...
public class EditGestureToThing extends AppCompatActivity {
    ...
    TextInputEditText textInputEditGesture;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInputEditGesture = (TextInputEditText) findViewById(R.id.textInputGesture);
        ...
        String gestureBoolArray = intent.getStringExtra("gestureBoolArray");
